...
import com.mr.framework.core.convert.BasicType;
...
import com.mr.framework.core.lang.ClassScaner;
...
public class ClassUtil {
	 ...
	 * 
	 * <pre>
	 * isSimple为false: "com.fengj.tool.util.ClassUtil"
	 ...
	 * 例如：com.fengj.tool.StrUtil.isEmpty 或 com.fengj.tool.StrUtil#isEmpty
	 ...
	 * 
	 * @param <T> 对象类型
	 * @param classNameWithMethodName 类名和方法名表达式，例如：com.fengj.tool.StrUtil#isEmpty或com.fengj.tool.StrUtil.isEmpty
	 ...
	 * 获得给定类所在包的名称<br>
	 * 例如：<br>
	 * com.fengj.tool.util.ClassUtil =》 com.fengj.tool.util
	 * 
	 * @param clazz 类
	 * @return 包名
	 */
