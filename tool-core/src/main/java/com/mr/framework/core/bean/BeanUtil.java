package com.mr.framework.core.bean;
...
import com.mr.framework.core.bean.BeanDesc.PropDesc;
import com.mr.framework.core.bean.copier.BeanCopier;
import com.mr.framework.core.bean.copier.CopyOptions;
import com.mr.framework.core.bean.copier.ValueProvider;
import com.mr.framework.core.collection.CollUtil;
import com.mr.framework.core.convert.Convert;
import com.mr.framework.core.lang.Editor;
import com.mr.framework.core.map.CaseInsensitiveMap;
...
public class BeanUtil {
	 ...
	 * 如果isSimple为{@code false}，则只匹配类名而忽略包名，例如：com.mr.framework.TestEntity只匹配TestEntity<br>
	 * 如果isSimple为{@code true}，则匹配包括包名的全类名，例如：com.mr.framework.TestEntity匹配com.mr.framework.TestEntity
	 * 
	 * @param bean Bean
