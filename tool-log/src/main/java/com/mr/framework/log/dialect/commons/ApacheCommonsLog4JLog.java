package com.mr.framework.log.dialect.commons;
...
import com.mr.framework.log.AbstractLocationAwareLog;
...
public class ApacheCommonsLog4JLog extends AbstractLocationAwareLog {
	...
	@Override
	public void log(String fqcn, com.mr.framework.log.level.Level level, Throwable t, String format, Object... arguments) {
		Level log4jLevel;
		switch (level) {
			case TRACE:
