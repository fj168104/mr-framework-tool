...
import com.mr.framework.core.codec.Base64;
...
public class HttpRequest extends HttpBase<HttpRequest> {
	...
	private static final String BOUNDARY = "--------------------tool_" + RandomUtil.randomString(16);
	 ...
	 * 2. Rest模式，此时body需要传入一个JSON或者XML字符串，tool会自动绑定其对应的Content-Type
	 * </pre>
	 * 
	 * @param body 请求体
